...
# ======================================================================
# Q20. You have a bomb to defuse, and your time is running out! Your informer will provide you with a circular array code of length of n and a key k.
...
# =================> Way 01 using traditional way <========================================
# code = list(map(int, input("Enter the list of numbers (space-separated): ").split()))
...
# if k > 0:
#     for i in range(n):
#         output = sum(extended_code[i + 1: i + 1 + k])
#         result.append(output)
#
# else:
#     k = abs(k)
#     for i in range(n):
#         output = sum(extended_code[i + n - k: i + n])
#         result.append(output)
#
# print(f"Resulted code is {result}")
...
#         n = len(code)
#         self.result = []  # define here to avoid AttributeError
#
#         if k == 0:
#             self.result = [0] * n
#             return  # only ends function, doesn't return a value
#
#         extended_code = code * 3  # repeated to handle circular cases easily
#
#         if k > 0:
#             for i in range(n):
#                 output = sum(extended_code[i + 1: i + 1 + k])
...
# obj = Solution(code, k)
# print("Decrypted code:", obj.result)
